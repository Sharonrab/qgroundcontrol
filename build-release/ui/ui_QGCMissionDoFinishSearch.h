...
public:
    ...
    {
        QGCMissionDoFinishSearch->setWindowTitle(QApplication::translate("QGCMissionDoFinishSearch", "Form", 0));
#ifndef QT_NO_TOOLTIP
        param1SpinBox->setToolTip(QApplication::translate("QGCMissionDoFinishSearch", "Jump to this index, if search successful", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param1SpinBox->setStatusTip(QApplication::translate("QGCMissionDoFinishSearch", "Jump to this index, if search successful", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        param1SpinBox->setWhatsThis(QString());
#endif // QT_NO_WHATSTHIS
        param1SpinBox->setPrefix(QApplication::translate("QGCMissionDoFinishSearch", "Jump to index: ", 0));
        param1SpinBox->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        param2SpinBox->setToolTip(QApplication::translate("QGCMissionDoFinishSearch", "Jump to this index, if search unsuccessful", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param2SpinBox->setStatusTip(QApplication::translate("QGCMissionDoFinishSearch", "Jump to this index, if search unsuccessful", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        param2SpinBox->setWhatsThis(QString());
#endif // QT_NO_WHATSTHIS
        param2SpinBox->setPrefix(QApplication::translate("QGCMissionDoFinishSearch", "Jump to index:  ", 0));
#ifndef QT_NO_TOOLTIP
        param3SpinBox->setToolTip(QApplication::translate("QGCMissionDoFinishSearch", "Remaining number of jumps. Terminate search if jumps == 0.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param3SpinBox->setStatusTip(QApplication::translate("QGCMissionDoFinishSearch", "Remaining number of jumps. Terminate search if jumps == 0.", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        param3SpinBox->setWhatsThis(QString());
#endif // QT_NO_WHATSTHIS
        param3SpinBox->setPrefix(QString());
        param3SpinBox->setSuffix(QApplication::translate("QGCMissionDoFinishSearch", " time(s)", 0));
    } // retranslateUi
