...
public:
    ...
    {
        QGCHilConfiguration->setWindowTitle(QApplication::translate("QGCHilConfiguration", "Form", 0));
        simLabel->setText(QApplication::translate("QGCHilConfiguration", "Simulator", 0));
        simComboBox->clear();
        simComboBox->insertItems(0, QStringList()
         << QString()
         << QApplication::translate("QGCHilConfiguration", "FlightGear 3.0+", 0)
         << QApplication::translate("QGCHilConfiguration", "X-Plane 10", 0)
         << QApplication::translate("QGCHilConfiguration", "X-Plane 9", 0)
         << QApplication::translate("QGCHilConfiguration", "JSBSim", 0)
        );
