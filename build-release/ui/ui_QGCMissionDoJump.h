...
public:
    ...
    {
        QGCMissionDoJump->setWindowTitle(QApplication::translate("QGCMissionDoJump", "Form", 0));
#ifndef QT_NO_TOOLTIP
        param1SpinBox->setToolTip(QApplication::translate("QGCMissionDoJump", "Mission element ID to jump to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param1SpinBox->setStatusTip(QApplication::translate("QGCMissionDoJump", "Mission element ID to jump to", 0));
#endif // QT_NO_STATUSTIP
        param1SpinBox->setPrefix(QApplication::translate("QGCMissionDoJump", "Jump to index ", 0));
        param1SpinBox->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        param2SpinBox->setToolTip(QApplication::translate("QGCMissionDoJump", "Maximal number of jumps", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param2SpinBox->setStatusTip(QApplication::translate("QGCMissionDoJump", "Maximal number of jumps", 0));
#endif // QT_NO_STATUSTIP
        param2SpinBox->setPrefix(QString());
        param2SpinBox->setSuffix(QApplication::translate("QGCMissionDoJump", " time(s)", 0));
    } // retranslateUi
