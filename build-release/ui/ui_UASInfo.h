...
public:
    ...
    {
        uasInfo->setWindowTitle(QApplication::translate("uasInfo", "Form", 0));
        label->setText(QApplication::translate("uasInfo", "Battery", 0));
        voltageLabel->setText(QApplication::translate("uasInfo", "12", 0));
        label_7->setText(QApplication::translate("uasInfo", "V", 0));
        batteryBar->setFormat(QApplication::translate("uasInfo", "%p%", 0));
        label_2->setText(QApplication::translate("uasInfo", "MAV RX Loss", 0));
        receiveLossLabel->setText(QApplication::translate("uasInfo", "0", 0));
        label_8->setText(QApplication::translate("uasInfo", "%", 0));
        receiveLossBar->setFormat(QApplication::translate("uasInfo", "%p%", 0));
        label_6->setText(QApplication::translate("uasInfo", "MAV TX Loss", 0));
        sendLossLabel->setText(QApplication::translate("uasInfo", "0", 0));
        label_11->setText(QApplication::translate("uasInfo", "%", 0));
        sendLossBar->setFormat(QApplication::translate("uasInfo", "%p%", 0));
        label_3->setText(QApplication::translate("uasInfo", "MCU Load", 0));
        loadLabel->setText(QApplication::translate("uasInfo", "0", 0));
        label_9->setText(QApplication::translate("uasInfo", "%", 0));
        loadBar->setFormat(QApplication::translate("uasInfo", "%p%", 0));
        errorLabel->setText(QApplication::translate("uasInfo", "No error status received yet", 0));
        label_4->setText(QApplication::translate("uasInfo", "CPU Load", 0));
        label_5->setText(QApplication::translate("uasInfo", "0", 0));
        label_10->setText(QApplication::translate("uasInfo", "%", 0));
    } // retranslateUi
