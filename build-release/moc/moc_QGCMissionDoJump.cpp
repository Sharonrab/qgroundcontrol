...
struct qt_meta_stringdata_QGCMissionDoJump_t {
    QByteArrayData data[1];
    char stringdata[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionDoJump_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCMissionDoJump_t qt_meta_stringdata_QGCMissionDoJump = {
    {
QT_MOC_LITERAL(0, 0, 16) // "QGCMissionDoJump"
...
const QMetaObject QGCMissionDoJump::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionDoJump.data,
      qt_meta_data_QGCMissionDoJump,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionDoJump::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionDoJump.stringdata))
