...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__WaypointLineItem_t, stringdata) + ofs \
...
const QMetaObject mapcontrol::WaypointLineItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__WaypointLineItem.data,
      qt_meta_data_mapcontrol__WaypointLineItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mapcontrol::WaypointLineItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__WaypointLineItem.stringdata))
