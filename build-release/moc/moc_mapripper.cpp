...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__MapRipper_t, stringdata) + ofs \
...
void mapcontrol::MapRipper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MapRipper::percentageChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (MapRipper::*_t)(int const & , int const & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MapRipper::numberOfTilesChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (MapRipper::*_t)(QString const & , int const & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MapRipper::providerChanged)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject mapcontrol::MapRipper::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_mapcontrol__MapRipper.data,
      qt_meta_data_mapcontrol__MapRipper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mapcontrol::MapRipper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__MapRipper.stringdata))
