...
struct qt_meta_stringdata_QGCMissionNavLand_t {
    QByteArrayData data[4];
    char stringdata[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionNavLand_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCMissionNavLand_t qt_meta_stringdata_QGCMissionNavLand = {
    {
QT_MOC_LITERAL(0, 0, 17), // "QGCMissionNavLand"
QT_MOC_LITERAL(1, 18, 11), // "updateFrame"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 9) // "MAV_FRAME"

    },
    "QGCMissionNavLand\0updateFrame\0\0MAV_FRAME"
};
...
const QMetaObject QGCMissionNavLand::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionNavLand.data,
      qt_meta_data_QGCMissionNavLand,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionNavLand::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionNavLand.stringdata))
