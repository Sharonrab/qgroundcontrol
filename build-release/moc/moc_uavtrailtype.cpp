...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__UAVTrailType_t, stringdata) + ofs \
...
void *mapcontrol::UAVTrailType::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__UAVTrailType.stringdata))
