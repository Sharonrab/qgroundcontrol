...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_internals__Core_t, stringdata) + ofs \
...
const QMetaObject internals::Core::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_internals__Core.data,
      qt_meta_data_internals__Core,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *internals::Core::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_internals__Core.stringdata))
