...
struct qt_meta_stringdata_QGCMissionDoFinishSearch_t {
    QByteArrayData data[1];
    char stringdata[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionDoFinishSearch_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCMissionDoFinishSearch_t qt_meta_stringdata_QGCMissionDoFinishSearch = {
    {
QT_MOC_LITERAL(0, 0, 24) // "QGCMissionDoFinishSearch"
...
const QMetaObject QGCMissionDoFinishSearch::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionDoFinishSearch.data,
      qt_meta_data_QGCMissionDoFinishSearch,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionDoFinishSearch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionDoFinishSearch.stringdata))
