...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_internals__MouseWheelZoomType_t, stringdata) + ofs \
...
const QMetaObject internals::MouseWheelZoomType::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_internals__MouseWheelZoomType.data,
      qt_meta_data_internals__MouseWheelZoomType,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *internals::MouseWheelZoomType::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_internals__MouseWheelZoomType.stringdata))
