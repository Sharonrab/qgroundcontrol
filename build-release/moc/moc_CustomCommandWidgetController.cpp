...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomCommandWidgetController_t, stringdata) + ofs \
...
void CustomCommandWidgetController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomCommandWidgetController::customQmlFileChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CustomCommandWidgetController::staticMetaObject = {
    { &FactPanelController::staticMetaObject, qt_meta_stringdata_CustomCommandWidgetController.data,
      qt_meta_data_CustomCommandWidgetController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CustomCommandWidgetController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomCommandWidgetController.stringdata))
        return static_cast<void*>(const_cast< CustomCommandWidgetController*>(this));
...
int CustomCommandWidgetController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _customQmlFile; break;
        default: break;
        }
        _id -= 1;
        ...
        switch (_id) {
        case 0:
            if (_customQmlFile != *reinterpret_cast< QString*>(_v)) {
                _customQmlFile = *reinterpret_cast< QString*>(_v);
                Q_EMIT customQmlFileChanged(_customQmlFile);
            }
            break;
        default: break;
        }
