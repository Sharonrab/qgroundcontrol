...
#include "../../src/AutoPilotPlugins/PX4/PowerComponent.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PowerComponent_t, stringdata) + ofs \
...
const QMetaObject PowerComponent::staticMetaObject = {
    { &PX4Component::staticMetaObject, qt_meta_stringdata_PowerComponent.data,
      qt_meta_data_PowerComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PowerComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PowerComponent.stringdata))
        return static_cast<void*>(const_cast< PowerComponent*>(this));
