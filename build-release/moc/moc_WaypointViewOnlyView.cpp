...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WaypointViewOnlyView_t, stringdata) + ofs \
...
void WaypointViewOnlyView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WaypointViewOnlyView::changeCurrentWaypoint)) {
                *result = 0;
            }
        }
        {
            typedef void (WaypointViewOnlyView::*_t)(quint16 , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WaypointViewOnlyView::changeAutoContinue)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject WaypointViewOnlyView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WaypointViewOnlyView.data,
      qt_meta_data_WaypointViewOnlyView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WaypointViewOnlyView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WaypointViewOnlyView.stringdata))
