...
struct qt_meta_stringdata_QGCMissionNavLoiterUnlim_t {
    QByteArrayData data[4];
    char stringdata[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionNavLoiterUnlim_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCMissionNavLoiterUnlim_t qt_meta_stringdata_QGCMissionNavLoiterUnlim = {
    {
QT_MOC_LITERAL(0, 0, 24), // "QGCMissionNavLoiterUnlim"
QT_MOC_LITERAL(1, 25, 11), // "updateFrame"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 9) // "MAV_FRAME"

    },
    "QGCMissionNavLoiterUnlim\0updateFrame\0"
    "\0MAV_FRAME"
};
...
const QMetaObject QGCMissionNavLoiterUnlim::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionNavLoiterUnlim.data,
      qt_meta_data_QGCMissionNavLoiterUnlim,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionNavLoiterUnlim::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionNavLoiterUnlim.stringdata))
