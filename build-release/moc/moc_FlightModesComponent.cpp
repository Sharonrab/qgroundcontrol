...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FlightModesComponent_t, stringdata) + ofs \
...
const QMetaObject FlightModesComponent::staticMetaObject = {
    { &PX4Component::staticMetaObject, qt_meta_stringdata_FlightModesComponent.data,
      qt_meta_data_FlightModesComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FlightModesComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FlightModesComponent.stringdata))
        return static_cast<void*>(const_cast< FlightModesComponent*>(this));
