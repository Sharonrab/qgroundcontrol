...
QT_MOC_LITERAL(3, 27, 4), // "curr"
QT_MOC_LITERAL(4, 32, 5) // "total"

    },
    "Bootloader\0updateProgress\0\0curr\0total"
};
...
void Bootloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Bootloader::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bootloader::updateProgress)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Bootloader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Bootloader.data,
