...
struct qt_meta_stringdata_QGCMissionNavWaypoint_t {
    QByteArrayData data[4];
    char stringdata[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionNavWaypoint_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCMissionNavWaypoint_t qt_meta_stringdata_QGCMissionNavWaypoint = {
    {
QT_MOC_LITERAL(0, 0, 21), // "QGCMissionNavWaypoint"
QT_MOC_LITERAL(1, 22, 11), // "updateFrame"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 9) // "MAV_FRAME"

    },
    "QGCMissionNavWaypoint\0updateFrame\0\0"
    "MAV_FRAME"
};
...
const QMetaObject QGCMissionNavWaypoint::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionNavWaypoint.data,
      qt_meta_data_QGCMissionNavWaypoint,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionNavWaypoint::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionNavWaypoint.stringdata))
