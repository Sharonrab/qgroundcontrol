...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCMissionNavSweep_t, stringdata) + ofs \
...
const QMetaObject QGCMissionNavSweep::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionNavSweep.data,
      qt_meta_data_QGCMissionNavSweep,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMissionNavSweep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionNavSweep.stringdata))
