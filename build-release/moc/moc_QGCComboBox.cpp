...
struct qt_meta_stringdata_QGCComboBox_t {
    QByteArrayData data[1];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCComboBox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCComboBox_t qt_meta_stringdata_QGCComboBox = {
    {
QT_MOC_LITERAL(0, 0, 11) // "QGCComboBox"
...
const QMetaObject QGCComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_QGCComboBox.data,
      qt_meta_data_QGCComboBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCComboBox.stringdata))
