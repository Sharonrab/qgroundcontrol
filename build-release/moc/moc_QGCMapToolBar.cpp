...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCMapToolBar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(10, 132, 18), // "setStatusLabelText"
QT_MOC_LITERAL(11, 151, 4) // "text"
    ...
    "setMapType\0setStatusLabelText\0text"
};
...
void QGCMapToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->setStatusLabelText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *QGCMapToolBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMapToolBar.stringdata))
