...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProtocolInterface_t, stringdata) + ofs \
...
void ProtocolInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProtocolInterface::receiveLossChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ProtocolInterface::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ProtocolInterface.data,
      qt_meta_data_ProtocolInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProtocolInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProtocolInterface.stringdata))
