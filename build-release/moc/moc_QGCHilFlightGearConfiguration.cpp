...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCHilFlightGearConfiguration_t, stringdata) + ofs \
...
void QGCHilFlightGearConfiguration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QGCHilFlightGearConfiguration::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGCHilFlightGearConfiguration::barometerOffsetChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QGCHilFlightGearConfiguration::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCHilFlightGearConfiguration.data,
      qt_meta_data_QGCHilFlightGearConfiguration,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCHilFlightGearConfiguration::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCHilFlightGearConfiguration.stringdata))
