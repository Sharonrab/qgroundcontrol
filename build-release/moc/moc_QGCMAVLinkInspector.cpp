...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCMAVLinkInspector_t, stringdata) + ofs \
...
const QMetaObject QGCMAVLinkInspector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMAVLinkInspector.data,
      qt_meta_data_QGCMAVLinkInspector,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMAVLinkInspector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMAVLinkInspector.stringdata))
