...
#include "../../src/AutoPilotPlugins/PX4/SensorsComponent.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SensorsComponent_t, stringdata) + ofs \
...
const QMetaObject SensorsComponent::staticMetaObject = {
    { &PX4Component::staticMetaObject, qt_meta_stringdata_SensorsComponent.data,
      qt_meta_data_SensorsComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SensorsComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SensorsComponent.stringdata))
        return static_cast<void*>(const_cast< SensorsComponent*>(this));
