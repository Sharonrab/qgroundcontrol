...
public:
    ...
    {
        QGCMissionDoStartSearch->setWindowTitle(QApplication::translate("QGCMissionDoStartSearch", "Form", 0));
#ifndef QT_NO_TOOLTIP
        param1SpinBox->setToolTip(QApplication::translate("QGCMissionDoStartSearch", "Minimal required detection confidence", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param1SpinBox->setStatusTip(QApplication::translate("QGCMissionDoStartSearch", "Minimal required detection confidence", 0));
#endif // QT_NO_STATUSTIP
        param1SpinBox->setPrefix(QApplication::translate("QGCMissionDoStartSearch", "Conf: ", 0));
#ifndef QT_NO_TOOLTIP
        param2SpinBox->setToolTip(QApplication::translate("QGCMissionDoStartSearch", "Required number of detections", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param2SpinBox->setStatusTip(QApplication::translate("QGCMissionDoStartSearch", "Required number of detections", 0));
#endif // QT_NO_STATUSTIP
        param2SpinBox->setPrefix(QApplication::translate("QGCMissionDoStartSearch", "#det: ", 0));
    } // retranslateUi
