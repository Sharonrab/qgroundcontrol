...
public:
    ...
    {
        QGCHilJSBSimConfiguration->setWindowTitle(QApplication::translate("QGCHilJSBSimConfiguration", "Form", 0));
        aircraftPlaintextInfoLabel->setText(QApplication::translate("QGCHilJSBSimConfiguration", "Airframe:", 0));
        optionsLabel->setText(QApplication::translate("QGCHilJSBSimConfiguration", "<html><head/><body><p>Additional Options:</p></body></html>", 0));
        ...
        startButton->setText(QApplication::translate("QGCHilJSBSimConfiguration", "Start", 0));
        stopButton->setText(QApplication::translate("QGCHilJSBSimConfiguration", "Stop", 0));
    } // retranslateUi
