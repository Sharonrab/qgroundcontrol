...
public:
    ...
    {
        QGCHilFlightGearConfiguration->setWindowTitle(QApplication::translate("QGCHilFlightGearConfiguration", "Form", 0));
        optionsLabel->setText(QApplication::translate("QGCHilFlightGearConfiguration", "<html><head/><body><p>Additional Options:</p></body></html>", 0));
        aircraftPlaintextInfoLabel->setText(QApplication::translate("QGCHilFlightGearConfiguration", "Airframe:", 0));
        optionsPlainTextEdit->setPlainText(QString());
        startButton->setText(QApplication::translate("QGCHilFlightGearConfiguration", "Start", 0));
        stopButton->setText(QApplication::translate("QGCHilFlightGearConfiguration", "Stop", 0));
        sensorHilCheckBox->setText(QApplication::translate("QGCHilFlightGearConfiguration", "Sensor HIL", 0));
        barometerOffsetLabel->setText(QApplication::translate("QGCHilFlightGearConfiguration", "Barometer Offset [kPa]:", 0));
        barometerOffsetLineEdit->setText(QApplication::translate("QGCHilFlightGearConfiguration", "0", 0));
    } // retranslateUi
