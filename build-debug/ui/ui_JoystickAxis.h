...
public:
    ...
    void setupUi(QWidget *JoystickAxis)
    {
        if (JoystickAxis->objectName().isEmpty())
            JoystickAxis->setObjectName(QStringLiteral("JoystickAxis"));
    ...
    {
        JoystickAxis->setWindowTitle(QApplication::translate("JoystickAxis", "Form", 0));
        label->setText(QString());
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("JoystickAxis", "--", 0)
         << QApplication::translate("JoystickAxis", "Yaw", 0)
         << QApplication::translate("JoystickAxis", "Pitch", 0)
         << QApplication::translate("JoystickAxis", "Roll", 0)
         << QApplication::translate("JoystickAxis", "Throttle", 0)
        );
#ifndef QT_NO_TOOLTIP
        comboBox->setToolTip(QApplication::translate("JoystickAxis", "Specify what property of the UAS this axis should command", 0));
#endif // QT_NO_TOOLTIP
        rangeCheckBox->setText(QApplication::translate("JoystickAxis", "Half range", 0));
#ifndef QT_NO_TOOLTIP
        progressBar->setToolTip(QApplication::translate("JoystickAxis", "Only use the positive values from this axis for control", 0));
#endif // QT_NO_TOOLTIP
        progressBar->setFormat(QApplication::translate("JoystickAxis", "%v", 0));
#ifndef QT_NO_TOOLTIP
        invertedCheckBox->setToolTip(QApplication::translate("JoystickAxis", "Reverse the values for this axis", 0));
#endif // QT_NO_TOOLTIP
        invertedCheckBox->setText(QApplication::translate("JoystickAxis", "Inverted", 0));
    } // retranslateUi
