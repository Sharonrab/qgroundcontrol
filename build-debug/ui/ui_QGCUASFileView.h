...
public:
    ...
    {
        QGCUASFileView->setWindowTitle(QApplication::translate("QGCUASFileView", "Form", 0));
        listFilesButton->setText(QApplication::translate("QGCUASFileView", "List Files", 0));
        downloadButton->setText(QApplication::translate("QGCUASFileView", "Download File", 0));
        statusText->setText(QString());
        uploadButton->setText(QApplication::translate("QGCUASFileView", "Upload File", 0));
    } // retranslateUi
