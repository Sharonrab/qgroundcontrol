...
public:
    ...
    {
        linechart->setWindowTitle(QApplication::translate("linechart", "Form", 0));
        plotFilterLineEdit->setPlaceholderText(QApplication::translate("linechart", "Filter... (Ctrl+F)", 0));
        uasSelectionBox->clear();
        uasSelectionBox->insertItems(0, QStringList()
         << QApplication::translate("linechart", "All MAVs", 0)
        );
#ifndef QT_NO_TOOLTIP
        shortNameCheckBox->setToolTip(QApplication::translate("linechart", "Display only variable names in curve list", 0));
#endif // QT_NO_TOOLTIP
        shortNameCheckBox->setText(QApplication::translate("linechart", "Short names", 0));
#ifndef QT_NO_TOOLTIP
        showUnitsCheckBox->setToolTip(QApplication::translate("linechart", "Display variable units in curve list", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        showUnitsCheckBox->setWhatsThis(QApplication::translate("linechart", "Display variable units in curve list", 0));
#endif // QT_NO_WHATSTHIS
        showUnitsCheckBox->setText(QApplication::translate("linechart", "Show units", 0));
#ifndef QT_NO_TOOLTIP
        recolorButton->setToolTip(QApplication::translate("linechart", "Rotate color scheme for all curves", 0));
#endif // QT_NO_TOOLTIP
        recolorButton->setText(QApplication::translate("linechart", "Recolor", 0));
    } // retranslateUi
