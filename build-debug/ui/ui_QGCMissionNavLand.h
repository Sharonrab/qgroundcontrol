...
public:
    ...
    void setupUi(QWidget *QGCMissionNavLand)
    {
        if (QGCMissionNavLand->objectName().isEmpty())
            QGCMissionNavLand->setObjectName(QStringLiteral("QGCMissionNavLand"));
        ...
        QGCMissionNavLand->setStyleSheet(QStringLiteral(""));
    ...
    {
        QGCMissionNavLand->setWindowTitle(QApplication::translate("QGCMissionNavLand", "Form", 0));
#ifndef QT_NO_TOOLTIP
        posNSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Position X coordinate", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posNSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Position X corrdinate", 0));
#endif // QT_NO_STATUSTIP
        posNSpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "N ", 0));
        posNSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", " m", 0));
#ifndef QT_NO_TOOLTIP
        posESpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Position Y/Longitude coordinate", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posESpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Position Y/Longitude coordinate", 0));
#endif // QT_NO_STATUSTIP
        posESpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "E ", 0));
        posESpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", " m", 0));
#ifndef QT_NO_TOOLTIP
        posDSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Position Z coordinate (local frame, negative)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posDSpinBox->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        posDSpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "D ", 0));
        posDSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", " m", 0));
#ifndef QT_NO_TOOLTIP
        latSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Latitude in degrees", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        latSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Latitude in degrees", 0));
#endif // QT_NO_STATUSTIP
        latSpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "lat ", 0));
        latSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", "\302\260", 0));
#ifndef QT_NO_TOOLTIP
        lonSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Longitude in degrees", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        lonSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Longitude in degrees", 0));
#endif // QT_NO_STATUSTIP
        lonSpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "lon ", 0));
        lonSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", "\302\260", 0));
#ifndef QT_NO_TOOLTIP
        altSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Altitude in meters", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        altSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Altitude in meters", 0));
#endif // QT_NO_STATUSTIP
        altSpinBox->setPrefix(QApplication::translate("QGCMissionNavLand", "alt ", 0));
        altSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", "m", 0));
#ifndef QT_NO_TOOLTIP
        yawSpinBox->setToolTip(QApplication::translate("QGCMissionNavLand", "Rotary wing only: Desired yaw angle at waypoint", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        yawSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLand", "Rotary wing only: Desired yaw angle at waypoint", 0));
#endif // QT_NO_STATUSTIP
        yawSpinBox->setPrefix(QString());
        yawSpinBox->setSuffix(QApplication::translate("QGCMissionNavLand", "\302\260", 0));
    } // retranslateUi
