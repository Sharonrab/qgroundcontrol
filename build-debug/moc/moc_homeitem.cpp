...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__HomeItem_t, stringdata) + ofs \
...
const QMetaObject mapcontrol::HomeItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__HomeItem.data,
...
void *mapcontrol::HomeItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__HomeItem.stringdata))
