...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__UAVMapFollowType_t, stringdata) + ofs \
...
const QMetaObject mapcontrol::UAVMapFollowType::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__UAVMapFollowType.data,
      qt_meta_data_mapcontrol__UAVMapFollowType,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mapcontrol::UAVMapFollowType::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__UAVMapFollowType.stringdata))
