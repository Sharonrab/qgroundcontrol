...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mapcontrol__UAVItem_t, stringdata) + ofs \
...
void mapcontrol::UAVItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UAVItem::UAVReachedWayPoint)) {
                *result = 0;
            }
        }
        {
            typedef void (UAVItem::*_t)(internals::PointLatLng const & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UAVItem::UAVLeftSafetyBouble)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject mapcontrol::UAVItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__UAVItem.data,
      qt_meta_data_mapcontrol__UAVItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *mapcontrol::UAVItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__UAVItem.stringdata))
