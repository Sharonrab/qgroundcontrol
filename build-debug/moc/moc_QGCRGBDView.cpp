...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCRGBDView_t, stringdata) + ofs \
...
const QMetaObject QGCRGBDView::staticMetaObject = {
    { &HUD::staticMetaObject, qt_meta_stringdata_QGCRGBDView.data,
      qt_meta_data_QGCRGBDView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCRGBDView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCRGBDView.stringdata))
