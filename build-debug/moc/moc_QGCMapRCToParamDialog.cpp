...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCMapRCToParamDialog_t, stringdata) + ofs \
...
void QGCMapRCToParamDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGCMapRCToParamDialog::mapRCToParamDialogResult)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QGCMapRCToParamDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QGCMapRCToParamDialog.data,
      qt_meta_data_QGCMapRCToParamDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCMapRCToParamDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCMapRCToParamDialog.stringdata))
        return static_cast<void*>(const_cast< QGCMapRCToParamDialog*>(this));
