...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChartPlot_t, stringdata) + ofs \
...
const QMetaObject ChartPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_ChartPlot.data,
      qt_meta_data_ChartPlot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ChartPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChartPlot.stringdata))
