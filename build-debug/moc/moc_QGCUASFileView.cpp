...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGCUASFileView_t, stringdata) + ofs \
...
const QMetaObject QGCUASFileView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCUASFileView.data,
      qt_meta_data_QGCUASFileView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGCUASFileView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCUASFileView.stringdata))
        return static_cast<void*>(const_cast< QGCUASFileView*>(this));
