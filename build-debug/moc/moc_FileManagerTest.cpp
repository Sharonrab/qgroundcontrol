...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileManagerTest_t, stringdata) + ofs \
...
const QMetaObject FileManagerTest::staticMetaObject = {
    { &UnitTest::staticMetaObject, qt_meta_stringdata_FileManagerTest.data,
      qt_meta_data_FileManagerTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileManagerTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileManagerTest.stringdata))
        return static_cast<void*>(const_cast< FileManagerTest*>(this));
