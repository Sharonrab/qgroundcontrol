...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_core__GeoCoderStatusCode_t, stringdata) + ofs \
...
const QMetaObject core::GeoCoderStatusCode::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_core__GeoCoderStatusCode.data,
      qt_meta_data_core__GeoCoderStatusCode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *core::GeoCoderStatusCode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_core__GeoCoderStatusCode.stringdata))
