...
QT_MOC_LITERAL(10, 99, 14), // "LinkInterface*"
QT_MOC_LITERAL(11, 114, 4), // "link"
QT_MOC_LITERAL(12, 119, 17), // "mavlink_message_t"
QT_MOC_LITERAL(13, 137, 7), // "message"
QT_MOC_LITERAL(14, 145, 11) // "_ackTimeout"
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->receiveMessage((*reinterpret_cast< LinkInterface*(*)>(_a[1])),(*reinterpret_cast< mavlink_message_t(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::listEntry)) {
                *result = 0;
            }
        }
        {
            typedef void (FileManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::commandComplete)) {
                *result = 1;
            }
        }
        {
            typedef void (FileManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::commandError)) {
                *result = 2;
            }
        }
        {
            typedef void (FileManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::commandProgress)) {
                *result = 3;
            }
        }
    }
