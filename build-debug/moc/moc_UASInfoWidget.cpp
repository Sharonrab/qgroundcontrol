...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UASInfoWidget_t, stringdata) + ofs \
...
const QMetaObject UASInfoWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UASInfoWidget.data,
      qt_meta_data_UASInfoWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UASInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UASInfoWidget.stringdata))
