...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HexSpinBox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HexSpinBox_t qt_meta_stringdata_HexSpinBox = {
    {
QT_MOC_LITERAL(0, 0, 10) // "HexSpinBox"
...
const QMetaObject HexSpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata_HexSpinBox.data,
      qt_meta_data_HexSpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HexSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HexSpinBox.stringdata))
