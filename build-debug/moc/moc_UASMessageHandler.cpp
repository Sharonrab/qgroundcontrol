...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UASMessageHandler_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 89, 12), // "setActiveUAS"
QT_MOC_LITERAL(8, 102, 13), // "UASInterface*"
QT_MOC_LITERAL(9, 116, 3), // "uas"
QT_MOC_LITERAL(10, 120, 17), // "handleTextMessage"
QT_MOC_LITERAL(11, 138, 5), // "uasid"
QT_MOC_LITERAL(12, 144, 11), // "componentid"
QT_MOC_LITERAL(13, 156, 8), // "severity"
QT_MOC_LITERAL(14, 165, 4) // "text"

    },
    "UASMessageHandler\0textMessageReceived\0"
    "\0UASMessage*\0message\0textMessageCountChanged\0"
    "count\0setActiveUAS\0UASInterface*\0uas\0"
    "handleTextMessage\0uasid\0componentid\0"
    "severity\0text"
};
...
void UASMessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handleTextMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASMessageHandler::textMessageReceived)) {
                *result = 0;
            }
        }
        {
            typedef void (UASMessageHandler::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASMessageHandler::textMessageCountChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject UASMessageHandler::staticMetaObject = {
    { &QGCSingleton::staticMetaObject, qt_meta_stringdata_UASMessageHandler.data,
      qt_meta_data_UASMessageHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UASMessageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UASMessageHandler.stringdata))
        return static_cast<void*>(const_cast< UASMessageHandler*>(this));
