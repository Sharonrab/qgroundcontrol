...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_JoystickButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 15, 13), // "actionChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 2), // "id"
QT_MOC_LITERAL(4, 33, 5), // "index"
QT_MOC_LITERAL(5, 39, 12), // "setActiveUAS"
QT_MOC_LITERAL(6, 52, 13), // "UASInterface*"
QT_MOC_LITERAL(7, 66, 3), // "uas"
QT_MOC_LITERAL(8, 70, 9), // "setAction"
QT_MOC_LITERAL(9, 80, 21) // "actionComboBoxChanged"

    },
    "JoystickButton\0actionChanged\0\0id\0index\0"
    "setActiveUAS\0UASInterface*\0uas\0setAction\0"
    "actionComboBoxChanged"
};
...
void JoystickButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (JoystickButton::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickButton::actionChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject JoystickButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_JoystickButton.data,
      qt_meta_data_JoystickButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JoystickButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JoystickButton.stringdata))
