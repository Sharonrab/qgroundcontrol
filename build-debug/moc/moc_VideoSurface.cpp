...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoSurface_t, stringdata) + ofs \
...
const QMetaObject VideoSurface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoSurface.data,
...
void *VideoSurface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoSurface.stringdata))
