...
#include "../../src/AutoPilotPlugins/PX4/SafetyComponent.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SafetyComponent_t, stringdata) + ofs \
...
const QMetaObject SafetyComponent::staticMetaObject = {
    { &PX4Component::staticMetaObject, qt_meta_stringdata_SafetyComponent.data,
      qt_meta_data_SafetyComponent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SafetyComponent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SafetyComponent.stringdata))
        return static_cast<void*>(const_cast< SafetyComponent*>(this));
