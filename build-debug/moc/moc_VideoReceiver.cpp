...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoReceiver_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 26, 6), // "setUri"
QT_MOC_LITERAL(5, 33, 3) // "uri"

    },
    "VideoReceiver\0start\0\0stop\0setUri\0uri"
};
...
const QMetaObject VideoReceiver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoReceiver.data,
      qt_meta_data_VideoReceiver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VideoReceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoReceiver.stringdata))
        return static_cast<void*>(const_cast< VideoReceiver*>(this));
